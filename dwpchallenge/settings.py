...
DATABASES = {
    'default': {
        ...
        'NAME': 'dwpchallenge',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'dwp',
        'PASSWORD': 'dwpchallenge',
...
ROOT_URLCONF = 'dwpchallenge.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'dwpchallenge.wsgi.application'
